...
<footer class="page-footer">
    <div class="container">
        <div class="links"><a href="#">About</a><a href="#" onclick="contactInfo()">Contact</a><a href="#">Terms of
            use</a></div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #0ea0ff">
                    <h4 id="id_h4" style="color: #ffffff"></h4>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-light" type="button" id="book_btn_id" onclick="courtBookTrigger(this)"
                            value="" disabled>Book
                    </button>
                </div>
            </div>
