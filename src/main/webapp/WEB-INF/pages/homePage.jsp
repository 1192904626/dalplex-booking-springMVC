                ...
                <c:if test="${userStatus != null && userStatus != ''}">
                    ...
                    <c:if test="${adminStatus=='admin'}">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown"
                                                ...
                                                style="padding-right:32px;">Welcome ${currentUser.student_name}</a>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide"
                 style="background-image:url(https://res.cloudinary.com/dirbnqgl0/image/upload/v1531792215/slider3.jpg);height:700px;"></div>
            <div class="swiper-slide"
                 style="background-image:url(https://res.cloudinary.com/dvbwoaqub/image/upload/v1532617474/hgceoo0wrarlqspw6s8g.jpg);height:700px;"></div>
            <div class="swiper-slide"
                 style="background-image:url(https://res.cloudinary.com/dvbwoaqub/image/upload/v1532616971/p1c2irrmcmb7knjthpsx.jpg);height:700px;"></div>
        </div>
...
<main class="page lanidng-page">
    ...
    <section class="portfolio-block call-to-action border-bottom">
        <div class="container">
            <div class="d-flex justify-content-center align-items-center content">
                ...
                <a href="/login">
                    <button class="btn btn-outline-primary btn-lg" type="button">Join Us</button>
                </a></div>
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card special-skill-item border-0">
                        ...
                        <div class="card-body">
                            ...
                            </a>Drop by Dalplex during our regular hours of operation and speak to a Customer Service
                                Representative.
                                Better yet,&nbsp;<strong>drop&nbsp;by for a tour of the facilities! &nbsp; &nbsp; &nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</strong><br></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card special-skill-item border-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Dalhousie day camps provide parents with the opportunity to choose from
                                a variety of sport and recreational summer camp options, all designed to&nbsp;<strong>educate,
                                    challenge</strong>, and&nbsp;<strong>inspire</strong>children
                                ages 5-17.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card special-skill-item border-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Please be aware that we are open holiday hours for Canada Day on
                                Sunday, July 1.<br>
    ...
    <section>
        ...
        <div class="align-content-center">
            <div style="width: 100%">
                <iframe class="align-content-center" width="100%" height="500"
                        src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=6260%20South%20Street+(Dalplex)&amp;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed"
