                ...
                <div class="table-content" id="course_table">
                    <div class="row">
                        ...
                        <button type="button" class="btn btn-primary add-button" name="add_course" data-toggle="modal"
                                data-target="#addCourseModal">Add an Announcement
                        </button>
                            ...
                            <table class="col-sm-12 table table-bordered table-striped table-condensed cf">
                                ...
                                <c:forEach items="${announcementList}" var="announcement">
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="editannouncement(this)" class="btn btn-default"
                                               value=${announcement.id} data-toggle="modal"
                                               data-target="#editCourseModal">
                                                <i class="material-icons">border_color</i>
                                            </a>
                                        </td>
                                        <td>
                                            <a onclick="deleteannouncement(this)" class="btn btn-danger"
                                               data-toggle="modal" href="#myModal" value=${announcement.id}>
                ...
                <form id="add-course-form" class="form-horizontal" action="/announcement/list" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="a_content" placeholder="Say something"
                ...
                <form id="edit-course-form" class="form-horizontal" action="/announcement/list" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_content" placeholder="Say something"
                                       name="content" required>
                            </div>
                        </div>
                        <div class="form-group" style="display: none">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_id" placeholder="Say something"
                                       name="id" required>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="deleteannouncement" class="btn btn-primary" value="" type="button"
                            onclick="deleteConfirm()">Delete
                    </button>
                </div>
            </div>
        </div>
