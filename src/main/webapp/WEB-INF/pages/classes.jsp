                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 item">
                            <a style="pointer-events: none" href="image/desk.jpg" data-lightbox="photos">
                                <img class="img-fluid" style="width:220px;height:150px;"
                                     src=${comingCourse.course_cover_image_link}>
                            </a>
                            <label style="font-size:28px;padding-left:0px;">${comingCourse.course_name}</label>
                            <button class="btn btn-primary book-course" type="button" style="width:100%;"
                                    data-toggle="modal"
                                    data-target="#myModal" onclick="insertcourse(this)" value=${comingCourse.course_id}>
                                Book
                            </button>
                        </div>
                    </c:forEach>
