$(document).ready(function () {
    ...
    $("#admin_check_course").on('click', function(){
        ...
        $("#courtAndCourse").append("<div id=course_list><iframe style='border:none;'  width=98% height=500 src=/course/list></iframe></div>");
    });
    $("#admin_check_court").on('click', function(){
        ...
        $("#courtAndCourse").append("<div id=court_list><iframe style='border:none;'  width=98% height=500 src=/court/list></iframe></div>");
